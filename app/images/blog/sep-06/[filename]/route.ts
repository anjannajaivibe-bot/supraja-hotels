...
type Scene = "city" | "room" | "family" | "rail" | "local" | "culture" | "shopping";

const art: Record<string, { title: string; subtitle: string; scene: Scene; accent: string }> = {
  ...
  "shilparamam-hyderabad-stay.webp": { title: "Stay in Madhapur", subtitle: "A practical base for your Hyderabad itinerary", scene: "culture", accent: "#d6a73b" },
  ...
  "inorbit-mall-madhapur.webp": { title: "Madhapur City Stay", subtitle: "Keep shopping and work plans connected", scene: "shopping", accent: "#55a7c8" },
  ...
  "kims-kondapur-family-stay.webp": { title: "Family Stay Planning", subtitle: "Room, transport and flexible schedules", scene: "local", accent: "#4aa889" },
  ...
  "hafeezpet-travel-stay.webp": { title: "Station to Stay", subtitle: "Plan the complete local journey", scene: "local", accent: "#e17d4b" },
  ...
  "chandanagar-local-stay.webp": { title: "West Hyderabad Base", subtitle: "Lingampally, BHEL, Miyapur and beyond", scene: "city", accent: "#8f73b5" },
...
function sceneMarkup(scene: Scene, accent: string) {
  ...
  if (scene === "culture") return `<path d="M170 540 V390 L600 275 L1030 390 V540" fill="#fff" opacity=".93"/><path d="M220 410 H980" stroke="${accent}" stroke-width="18"/><g fill="#18314f" opacity=".9"><rect x="255" y="435" width="90" height="105" rx="8"/><rect x="395" y="410" width="90" height="130" rx="8"/><rect x="535" y="390" width="130" height="150" rx="8"/><rect x="715" y="410" width="90" height="130" rx="8"/><rect x="855" y="435" width="90" height="105" rx="8"/></g><circle cx="600" cy="335" r="34" fill="${accent}"/>`;
  if (scene === "shopping") return `<rect x="190" y="300" width="820" height="270" rx="32" fill="#fff" opacity=".94"/><path d="M260 350 H940 L885 455 H315 Z" fill="${accent}" opacity=".32"/><rect x="330" y="455" width="540" height="85" rx="18" fill="#18314f" opacity=".9"/><circle cx="430" cy="495" r="22" fill="#fff"/><circle cx="770" cy="495" r="22" fill="#fff"/><path d="M355 385 H845" stroke="#18314f" stroke-width="22" stroke-linecap="round"/>`;
  if (scene === "local") return `<path d="M90 520 C280 420 455 500 600 420 C760 330 900 360 1110 260" stroke="#fff" stroke-width="26" fill="none" opacity=".85"/><circle cx="270" cy="455" r="52" fill="${accent}"/><circle cx="725" cy="355" r="52" fill="#fff"/><circle cx="1010" cy="300" r="52" fill="${accent}"/><rect x="220" y="520" width="180" height="36" rx="18" fill="#fff" opacity=".85"/><rect x="640" y="430" width="180" height="36" rx="18" fill="#fff" opacity=".85"/>`;
