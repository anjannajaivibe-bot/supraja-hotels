...
export async function GET(request:NextRequest){
 ...
 if(format==="csv"){
  const rows=[
   ...
   ...attendance.map(r=>["Cleaning Staff",r.attendance_date,r.hotel_name,r.hotel_staff_members?.name||"",r.hotel_staff_members?.staff_type||"Cleaning",String(r.status||"").replace("_"," "),formatIndiaDateTime(r.marked_at),"","","",r.recorded_by_employee_name||""]),
